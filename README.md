    ...
    "PreToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "bash ~/.claude/plugins/marketplaces/braseidon-superpowers/hooks/examples/pre-commit-check-tasks.sh"
          }
        ]
      }
    ]
    ...
    "PostToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "bash ~/.claude/plugins/marketplaces/braseidon-superpowers/hooks/examples/post-task-complete-revalidate.sh"
          }
        ]
      }
    ]
    ...
    "Stop": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "bash ~/.claude/plugins/marketplaces/braseidon-superpowers/hooks/examples/stop-revalidate-user-gates.sh"
          }
        ]
      }
    ]
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "bash ~/.claude/plugins/marketplaces/braseidon-superpowers/hooks/examples/pre-task-blockedby-enforce.sh"
          }
        ]
      }
    ]
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "bash ~/.claude/plugins/marketplaces/braseidon-superpowers/hooks/examples/pre-agent-task-dispatch-validate.sh"
          }
        ]
      }
    ]
    ...
    "PostToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "bash ~/.claude/plugins/marketplaces/braseidon-superpowers/hooks/examples/post-agent-return-validate.sh"
          }
        ]
      }
    ]
    ...
    "Stop": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "bash ~/.claude/plugins/marketplaces/braseidon-superpowers/hooks/examples/stop-deflection-guard.sh"
          }
        ]
      }
    ]
...
```bash
/plugin update superpowers@braseidon-superpowers
```
