...
function readSuperpowersVersion() {
  ...
  for (const manifest of manifests) {
    try {
      ...
      // This manifest is missing or has no version; try the next.
    }
  }
...
function brandMarkup() {
  ...
  return '<div class="brand"><a href="https://github.com/braseidon/superpowers">' + logo + '<span class="brand-copy">' + text + '</span></a></div>';
}
